...
// Note: Lovable injects componentTagger through .lovable/vite.config.ts during editor builds.
// Keeping it here too causes duplicate JSX transforms and intermittent build failures.
