-- Update the trigger function to include expenses:delete_own for Employee role
...
BEGIN
  ...
  VALUES
    ...
    -- Expenses (view all, edit own, approve)
    (accountant_role_id, 'expenses:view'),
    (accountant_role_id, 'expenses:view_all'),
    (accountant_role_id, 'expenses:create'),
    (accountant_role_id, 'expenses:edit'),
    (accountant_role_id, 'expenses:edit_own'),
  ...
  -- Employee permissions (basic access - own expenses only)
  INSERT INTO role_permissions (role_id, permission)
  VALUES
    -- Clients
    ...
    -- Expenses (own only with delete)
    (employee_role_id, 'expenses:view_own'),
    (employee_role_id, 'expenses:create'),
    (employee_role_id, 'expenses:edit_own'),
    (employee_role_id, 'expenses:delete_own'),
    -- Products
  ...
  -- Viewer permissions (read-only - view all)
  INSERT INTO role_permissions (role_id, permission)
  VALUES
