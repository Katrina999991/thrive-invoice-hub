...
const Companies = () => {
  ...
  const [newCompany, setNewCompany] = useState({
    ...
    logo_url: "",
    default_due_days: 7,
    expense_tax_handling: "auto" as "auto" | "always" | "never",
...
{company_name}`,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const companyData = {
      ...
      expense_tax_handling: newCompany.expense_tax_handling,
...
{company_name}`,
  ...
  const handleEdit = (company: Company) => {
    ...
    setNewCompany({
      ...
      expense_tax_handling: (company.expense_tax_handling as "auto" | "always" | "never") || "auto",
