...
const ComparisonQuickBooks = () => {
  ...
  const translations = {
    FR: {
      ...
      introText: "Choisir un logiciel de gestion d'entreprise dépend de vos besoins réels. GestionFlow et QuickBooks permettent tous deux de gérer factures et finances, mais leur approche est très différente. GestionFlow se concentre sur la simplicité et l'efficacité pour les petites entreprises et les freelances, tandis que QuickBooks offre des fonctionnalités comptables plus complexes.",
      solutionsTitle: "Présentation des solutions",
      gestionflowDesc: "GestionFlow est un logiciel de gestion d'entreprise moderne, conçu pour les travailleurs autonomes et les PME. Il permet de gérer plusieurs entreprises dans un seul compte, les clients, la facturation, les dépenses, le suivi des heures avec conversion directe en factures",
      gestionflowHighlight: "inclus dans tous les plans",
      gestionflowDescEnd: ", les paiements en ligne et des rapports clairs (revenus, dépenses, taxes). L'application est installable sur ordinateur et mobile (PWA) pour un accès rapide partout.",
      quickbooksDesc: "QuickBooks est un logiciel de comptabilité reconnu, principalement orienté vers la tenue de livres et la collaboration avec des comptables. Il offre des fonctionnalités comptables avancées adaptées aux entreprises ayant des besoins de comptabilité plus complexes, mais peut être plus difficile à prendre en main pour les non-comptables.",
      tableTitle: "Tableau comparatif",
      featureCol: "Fonctionnalité",
      conclusionTitle: "Conclusion",
      conclusionGestionflow: "est idéal pour les entrepreneurs et freelances qui veulent une solution simple, moderne et multi-entreprises, avec des rapports clairs et une application installable.",
      conclusionQuickbooks: "convient davantage aux entreprises ayant des besoins comptables avancés et qui travaillent étroitement avec des comptables.",
      ...
      comparisonData: [
        ...
        { feature: "Export CSV (dépenses/revenus)", gestionflowNote: "Premium+", quickbooksNote: "Oui" },
        ...
        { feature: "Suivi des heures → Factures", gestionflowNote: "Inclus dans tous les plans", quickbooksNote: "Limité" },
        { feature: "Rapports de revenus", gestionflowNote: "Oui", quickbooksNote: "Comptables" },
        { feature: "Rapports de dépenses", gestionflowNote: "Oui", quickbooksNote: "Oui" },
        { feature: "Rapports de taxes", gestionflowNote: "Premium+", quickbooksNote: "Oui" },
        { feature: "Application installable (PWA)", gestionflowNote: "Oui", quickbooksNote: "Non" },
    ...
    EN: {
      ...
      introTitle: "Introduction",
      introText: "Choosing business management software depends on your actual needs. Both GestionFlow and QuickBooks allow you to manage invoices and finances, but their approach is very different. GestionFlow focuses on simplicity and efficiency for small businesses and freelancers, while QuickBooks offers more complex accounting features.",
      solutionsTitle: "Solutions Overview",
      gestionflowDesc: "GestionFlow is a modern business management software designed for self-employed workers and SMBs. It allows you to manage multiple companies in a single account, clients, invoicing, expenses, time tracking with direct conversion to invoices",
      gestionflowHighlight: "included in all plans",
      gestionflowDescEnd: ", online payments and clear reports (revenue, expenses, taxes). The app is installable on desktop and mobile (PWA) for quick access anywhere.",
      quickbooksDesc: "QuickBooks is a recognized accounting software, primarily focused on bookkeeping and collaboration with accountants. It offers advanced accounting features suited to businesses with more complex accounting needs, but can be harder to learn for non-accountants.",
      tableTitle: "Comparison Table",
      featureCol: "Feature",
      conclusionTitle: "Conclusion",
      conclusionGestionflow: "is ideal for entrepreneurs and freelancers who want a simple, modern, multi-company solution with clear reports and an installable app.",
      conclusionQuickbooks: "is more suitable for businesses with advanced accounting needs who work closely with accountants.",
      ...
      comparisonData: [
        ...
        { feature: "CSV export (expenses/revenue)", gestionflowNote: "Premium+", quickbooksNote: "Yes" },
        ...
        { feature: "Time tracking → Invoices", gestionflowNote: "Included in all plans", quickbooksNote: "Limited" },
        { feature: "Revenue reports", gestionflowNote: "Yes", quickbooksNote: "Accounting" },
        { feature: "Expense reports", gestionflowNote: "Yes", quickbooksNote: "Yes" },
        { feature: "Tax reports", gestionflowNote: "Premium+", quickbooksNote: "Yes" },
        { feature: "Installable app (PWA)", gestionflowNote: "Yes", quickbooksNote: "No" },
  ...
  useSEO({
    ...
    structuredData: {
      ...
      "url": "https://gestionflow.net/comparison/quickbooks",
